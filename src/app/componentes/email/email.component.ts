...
export class EmailComponent implements OnInit {
  ...
  send() {
    if (
      ...
      let to = 'romariomondlane88@gmail.com';
      let headers = new HttpHeaders();
      headers = headers.set('content-type', 'form-data');
      headers = headers.set('Acces-Control-Allow', '*');
      this.http
        .get(
          `https://emailserver1.herokuapp.com/email?to=${to}
     &from=${this.emailFormControl.value}&subject=${this.SubjectFormControl.value}&body=${msg}`,
